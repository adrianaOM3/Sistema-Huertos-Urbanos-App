    ...
    public partial class LastMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PestsPestId = table.Column<int>(type: "int", nullable: false),
                    PlantsPlantId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PestPlant", x => new { x.PestsPestId, x.PlantsPlantId });
                    table.ForeignKey(
                        name: "FK_PestPlant_Pests_PestsPestId",
                        column: x => x.PestsPestId,
                        principalTable: "Pests",
                        principalColumn: "PestId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PestPlant_Plants_PlantsPlantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PestPlant_PlantsPlantId",
                table: "PestPlant",
